...
func (x *GetGoodsResponse) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *GetGoodsResponse) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *GetGoodsResponse) GetPrice() float32 {
	if x != nil {
		return x.Price
	}
	return 0
...
func (x *GetGoodsResponse) GetStock() int64 {
	if x != nil {
		return x.Stock
	}
	return 0
...
const file_proto_goods_proto_rawDesc = "" +
	"\n" +
	"\x11proto/goods.proto\x12\x05goods\"!\n" +
	"\x0fGetGoodsRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\"b\n" +
	"\x10GetGoodsResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x14\n" +
	"\x05price\x18\x03 \x01(\x02R\x05price\x12\x14\n" +
	"\x05stock\x18\x04 \x01(\x03R\x05stock2M\n" +
	"\fGoodsService\x12=\n" +
	"\bGetGoods\x12\x16.goods.GetGoodsRequest\x1a\x17.goods.GetGoodsResponse\"\x00B\x0fZ\r./proto/goodsb\x06proto3"
...
var file_proto_goods_proto_goTypes = []any{
	(*GetGoodsRequest)(nil),  // 0: goods.GetGoodsRequest
	(*GetGoodsResponse)(nil), // 1: goods.GetGoodsResponse
}
var file_proto_goods_proto_depIdxs = []int32{
	0, // 0: goods.GoodsService.GetGoods:input_type -> goods.GetGoodsRequest
	1, // 1: goods.GoodsService.GetGoods:output_type -> goods.GetGoodsResponse
