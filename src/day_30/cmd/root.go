...
import (
	"golang_per_day_30/internal/config"
	"os"
...
var rootCmd = &cobra.Command{
	Use:   "golang_per_day_30",
	Short: "golang_per_day_30",
	Long:  ``,
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.golang_per_day_30.yaml)")
